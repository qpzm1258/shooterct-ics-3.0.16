...
unsigned int shooter_ct_get_engineerid(void)
{
	return engineerid;
}
...
#ifdef CONFIG_PERFLOCK
static unsigned shooter_ct_perf_acpu_table[] = {
	384000000,
	756000000,
	1188000000,
};

static struct perflock_platform_data shooter_ct_perflock_data = {
	.perf_acpu_table = shooter_ct_perf_acpu_table,
	.table_size = ARRAY_SIZE(shooter_ct_perf_acpu_table),
};
#endif
...
static struct isa1200_platform_data isa1200_1_pdata = {
	...
	.hap_en_gpio = PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_HAP_ENABLE),
	.max_timeout = 15000,
...
/* ToDo: mark it */
/* #if defined(CONFIG_USB_GADGET_MSM_72K) || defined(CONFIG_USB_EHCI_MSM_72K) */
static int shooter_ct_phy_init_seq[] = { 0x06, 0x36, 0x0C, 0x31, 0x31, 0x32, 0x1, 0x0E, 0x1, 0x11, -1 };
static struct msm_otg_platform_data msm_otg_pdata = {
	.phy_init_seq		= shooter_ct_phy_init_seq,
	.mode			= USB_PERIPHERAL,
...
static struct htc_battery_platform_data htc_battery_pdev_data = {
	...
	.gpio_mbat_in = MSM_GPIO_TO_INT(SHOOTER_CT_GPIO_MBAT_IN),
...
static uint32_t camera_off_gpio_table_sp3d[] = {
	GPIO_CFG(SHOOTER_CT_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),/*i2c*/
	GPIO_CFG(SHOOTER_CT_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),/*i2c*/
	GPIO_CFG(SHOOTER_CT_SP3D_MCLK, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*MCLK*/
	GPIO_CFG(106, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/*sharp INT*/
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DO, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DI, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CS, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CLK, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_GATE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_CORE_GATE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SYS_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_PDX, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_WEBCAM_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*camera reset*/
	GPIO_CFG(SHOOTER_CT_WEBCAM_STB, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*camera standby*/
	GPIO_CFG(SHOOTER_CT_CAM_SEL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*camera switch*/
};

static uint32_t camera_on_gpio_table_sp3d[] = {
	GPIO_CFG(SHOOTER_CT_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_SP3D_MCLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*MCLK*/
	GPIO_CFG(106, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DO,  1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DI,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CS,  1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_GATE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_CORE_GATE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SYS_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_PDX, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_WEBCAM_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_WEBCAM_STB, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_CAM_SEL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static uint32_t sp3d_spi_gpio[] = {
	/* or this? the i/o direction and up/down are much more correct */
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DO,  1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DI,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CS,  1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
};
#endif
...
static uint32_t camera_off_gpio_table_liteon[] = {
	...
	GPIO_CFG(SHOOTER_CT_SP3D_MCLK, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*MCLK*/
	GPIO_CFG(106, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/*sharp INT*/
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DO, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DI, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CS, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CLK, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_S5K4E1_VCM_PD, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_S5K4E1_INTB, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_S5K4E1_PD, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_WEBCAM_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*camera reset*/
	GPIO_CFG(SHOOTER_CT_WEBCAM_STB, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*camera standby*/
	GPIO_CFG(SHOOTER_CT_CAM_SEL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),/*camera switch*/
};
...
static uint32_t camera_on_gpio_table_liteon[] = {
	...
	GPIO_CFG(106, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DO,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_DI,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CS,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SP3D_SPI_CLK, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_S5K4E1_VCM_PD, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_S5K4E1_INTB, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_S5K4E1_PD, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_WEBCAM_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_WEBCAM_STB, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_CAM_SEL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static struct regulator *shooter_ct_reg_8901_l6 = NULL;
static struct regulator *shooter_ct_reg_8058_l10 = NULL;
static struct regulator *shooter_ct_reg_8058_l15 = NULL;
...
static struct regulator *shooter_ct_reg_8901_lvs2 = NULL;
static struct regulator *shooter_ct_reg_8901_lvs3 = NULL;
...
static void shooter_ct_set_gpio(int gpio, int state)
{
	gpio_set_value(gpio, state);
}

#ifdef CONFIG_SP3D
static int Shooter_CT_sp3d_vreg_on(void)
{
	int rc = 0;
	pr_info("[CAM]%s\n", __func__);
	/* VDDIO*/
	rc = camera_sensor_power_enable_8901("8901_lvs2", &shooter_ct_reg_8901_lvs2);
	pr_info("[CAM] sensor_power_enable(\"8901_lvs2\", 1800) == %d\n", rc);
	udelay(26);
	/*DVDD18 */
	rc = camera_sensor_power_enable_8901("8901_lvs3", &shooter_ct_reg_8901_lvs3);
	pr_info("[CAM] sensor_power_enable(\"8901_lvs3\", 1800) == %d\n", rc);
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_CORE_GATE, 1); /* CORE GATE */
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_SYS_RST, 1); /* RST */
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_PDX, 1); /* PDX */
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_GATE, 1); /* GATE */
	/* main camera AVDD */
	rc = camera_sensor_power_enable("8058_l15", 2800000, &shooter_ct_reg_8058_l15);
	pr_info("[CAM] sensor_power_enable(\"8058_l15\", 2800) == %d\n", rc);
	/* main camera MVDD */
	rc = camera_sensor_power_enable("8058_l10", 2800000, &shooter_ct_reg_8058_l10);
...
static int Shooter_CT_sp3d_vreg_off(void)
{

	int rc = 0;
	pr_info("[CAM] %s\n", __func__);
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_PDX, 0); /* PDX */
	/* main camera MVDD */
	rc = camera_sensor_power_disable(shooter_ct_reg_8058_l10);
	udelay(10);
	/* main camera AVDD */
	if (engineerid == 0x1){
		rc = camera_sensor_power_disable(shooter_ct_reg_8058_l15);
		udelay(10);
	}
	/* main camera DVDD18 */
	rc = camera_sensor_power_disable(shooter_ct_reg_8901_lvs3);
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_SYS_RST, 0); // RST
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_CORE_GATE, 0); // CORE GATE
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_GATE, 0); // GATE
	/*VDDIO*/
	rc = camera_sensor_power_disable(shooter_ct_reg_8901_lvs2);
	return rc;
}
#endif

#ifdef CONFIG_QS_S5K4E1
static int Shooter_CT_qs_s5k4e1_vreg_on(void)
{
	int rc = 0;
	pr_info("[CAM] %s\n", __func__);
	mdelay(50);
	...
	shooter_ct_set_gpio(SHOOTER_CT_S5K4E1_INTB, 1);
	shooter_ct_set_gpio(SHOOTER_CT_S5K4E1_PD, 1);
	shooter_ct_set_gpio(SHOOTER_CT_S5K4E1_VCM_PD, 1);

	return rc;
}

static int Shooter_CT_qs_s5k4e1_vreg_off(void)
{
	int rc = 0;
	pr_info("[CAM] %s\n", __func__);
	shooter_ct_set_gpio(SHOOTER_CT_S5K4E1_INTB, 0); /* interrupt */
	shooter_ct_set_gpio(SHOOTER_CT_S5K4E1_VCM_PD, 0); /* PDX */
	shooter_ct_set_gpio(SHOOTER_CT_S5K4E1_PD, 0); /* RST */
...
static int Shooter_CT_s5k6aafx_vreg_on(void)
{
	int rc = 0;
	pr_info("[CAM] %s\n", __func__);
	/* main / 2nd camera analog power */
	rc = camera_sensor_power_enable("8901_l6", 2850000, &shooter_ct_reg_8901_l6);
...
static int Shooter_CT_s5k6aafx_vreg_off(void)
{
	int rc;
	pr_info("[CAM] %s\n", __func__);
	/* IO power off */
	...
	/* main / 2nd camera analog power */
	rc = camera_sensor_power_disable(shooter_ct_reg_8901_l6);
	pr_info("[CAM] sensor_power_disable(\"8901_l6\") == %d\n", rc);

	return rc;
}

static void Shooter_CT_maincam_clk_switch(void)
{
	pr_info("[CAM] Doing clk switch (Main Cam)\n");
	gpio_set_value(SHOOTER_CT_CAM_SEL, 0);
}

static void Shooter_CT_seccam_clk_switch(void)
{
	pr_info("[CAM] Doing clk switch (2nd Cam)\n");
	gpio_set_value(SHOOTER_CT_CAM_SEL, 1);
}

static int shooter_ct_config_camera_on_gpios(void)
{
	if (engineerid == 0x0) {
...
static void shooter_ct_config_camera_off_gpios(void)
{
	if (engineerid == 0x0) {
	...
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_SPI_DO, 0);
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_SPI_CS, 0);
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_SPI_CLK, 0);
	shooter_ct_set_gpio(SHOOTER_CT_SP3D_MCLK, 0);
	shooter_ct_set_gpio(SHOOTER_CT_CAM_SEL, 0);
}

static struct msm_camera_device_platform_data msm_camera_device_data = {
	.camera_gpio_on  = shooter_ct_config_camera_on_gpios,
	.camera_gpio_off = shooter_ct_config_camera_off_gpios,
...
static struct msm_camera_sensor_info msm_camera_sensor_sp3d_data = {
	.sensor_name	= "sp3d",
	.vcm_enable		= 0,
	.camera_power_on = Shooter_CT_sp3d_vreg_on,
	.camera_power_off = Shooter_CT_sp3d_vreg_off,
	.camera_clk_switch = Shooter_CT_maincam_clk_switch,
...
static struct msm_camera_sensor_info msm_camera_sensor_qs_s5k4e1_data = {
	...
	.sensor_reset	= SHOOTER_CT_S5K4E1_PD,
	.vcm_enable		= 0,
	.camera_power_on = Shooter_CT_qs_s5k4e1_vreg_on,
	.camera_power_off = Shooter_CT_qs_s5k4e1_vreg_off,
	.camera_clk_switch = Shooter_CT_maincam_clk_switch,
	.pdata			= &msm_camera_device_data,
	.resource		= msm_camera_resources,
	.num_resources	= ARRAY_SIZE(msm_camera_resources),
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6aafx_data = {
	...
	.sensor_reset	= SHOOTER_CT_WEBCAM_RST,/*2nd Cam RST*/
	.sensor_pwd		= SHOOTER_CT_WEBCAM_STB,/*2nd Cam PWD*/
	.vcm_enable		= 0,
	.camera_power_on = Shooter_CT_s5k6aafx_vreg_on,
	.camera_power_off = Shooter_CT_s5k6aafx_vreg_off,
	.camera_clk_switch = Shooter_CT_seccam_clk_switch,
...
static struct tps65200_platform_data tps65200_data = {
	.charger_check = 1,
	.gpio_chg_stat = PM8058_GPIO_IRQ(PM8058_IRQ_BASE, SHOOTER_CT_CHG_STAT),
	.gpio_chg_int  = MSM_GPIO_TO_INT(SHOOTER_CT_GPIO_CHG_INT),
};
...
static uint32_t gsbi4_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_CT_CAM_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_CAM_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi5_gpio_table[] = {
	GPIO_CFG(SHOOTER_CT_TP_I2C_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_TP_I2C_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi5_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_CT_TP_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_TP_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi7_gpio_table[] = {
	GPIO_CFG(SHOOTER_CT_GENERAL_I2C_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_GENERAL_I2C_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi7_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_CT_GENERAL_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_GENERAL_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi10_gpio_table[] = {
	GPIO_CFG(SHOOTER_CT_SENSOR_I2C_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIOMUX_DRV_8MA),
	GPIO_CFG(SHOOTER_CT_SENSOR_I2C_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIOMUX_DRV_8MA),
};

static uint32_t gsbi10_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_CT_SENSOR_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_CT_SENSOR_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static struct platform_device shooter_ct_3Dpanel_device = {
	.name = "panel_3d",
	.id = -1,
};
...
static int shooter_ct_ts_atmel_power(int on)
{
	printk(KERN_INFO "%s: power %d\n", __func__, on);

	gpio_set_value(PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_TP_RST), 0);
	msleep(5);
	gpio_set_value(PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_TP_RST), 1);
	msleep(40);

	return 0;
}

struct atmel_i2c_platform_data shooter_ct_ts_atmel_data[] = {
	{
		.version = 0x011,
		.source = 1, /* Nissha */
		.build = 0xAA,
		...
		.abs_width_min = 0,
		.abs_width_max = 20,
		.gpio_irq = SHOOTER_CT_TP_ATT_N,
		.power = shooter_ct_ts_atmel_power,
		.unlock_attr = 1,
...
static struct i2c_board_info msm_i2c_gsbi5_info[] = {
	{
		...
		.platform_data = &shooter_ct_ts_atmel_data,
		.irq = MSM_GPIO_TO_INT(SHOOTER_CT_TP_ATT_N)
	},
};

static ssize_t shooter_ct_virtual_keys_show(struct kobject *kobj,
...
static struct kobj_attribute shooter_ct_virtual_keys_attr = {
	.attr = {
		.name = "virtualkeys.atmel-touchscreen",
		.mode = S_IRUGO,
	},
	.show = &shooter_ct_virtual_keys_show,
};

static struct attribute *shooter_ct_properties_attrs[] = {
	&shooter_ct_virtual_keys_attr.attr,
	NULL
};

static struct attribute_group shooter_ct_properties_attr_group = {
	.attrs = shooter_ct_properties_attrs,
};
...
static struct msm_serial_hs_platform_data msm_uart_dm1_pdata = {
	...
	.bt_wakeup_pin = SHOOTER_CT_GPIO_BT_CHIP_WAKE,
	.host_wakeup_pin = SHOOTER_CT_GPIO_BT_HOST_WAKE,
};
#endif

#ifdef CONFIG_BT
static struct platform_device shooter_ct_rfkill = {
	.name = "shooter_ct_rfkill",
	.id = -1,
};
#endif
...
static void config_flashlight_gpios(void)
{
	static uint32_t flashlight_gpio_table[] = {
		GPIO_CFG(SHOOTER_CT_TORCH_EN, 0, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
		GPIO_CFG(SHOOTER_CT_FLASH_EN, 0, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	};
...
static struct flashlight_platform_data flashlight_data = {
	...
	.torch 			= SHOOTER_CT_TORCH_EN,
	.flash 			= SHOOTER_CT_FLASH_EN,
	.torch_set1 = PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_TORCH_SET1),
	.torch_set2 = PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_TORCH_SET2),
...
static struct htc_headset_gpio_platform_data htc_headset_gpio_data = {
	.hpin_gpio		= SHOOTER_CT_GPIO_AUD_HP_DET,
	.key_enable_gpio	= 0,
	.mic_select_gpio	= 0,
};
...
static struct htc_headset_pmic_platform_data htc_headset_pmic_data = {
	...
	.hpin_gpio		= 0,
	.hpin_irq		= 0,
	.key_gpio		= PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_REMO_PRES),
	.key_irq		= 0,
	.key_enable_gpio	= PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_REMO_EN),
	.adc_mic_bias		= {0, 0},
...
static uint32_t usb_ID_PIN_input_table[] = {
	GPIO_CFG(SHOOTER_CT_GPIO_USB_ID, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static uint32_t usb_ID_PIN_ouput_table[] = {
	GPIO_CFG(SHOOTER_CT_GPIO_USB_ID, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static uint32_t mhl_usb_switch_ouput_table[] = {
	GPIO_CFG(SHOOTER_CT_GPIO_MHL_USB_SWITCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
};
...
void config_shooter_ct_usb_id_gpios(bool output)
{
	if (output) {
		gpio_tlmm_config(usb_ID_PIN_ouput_table[0], 0);
		gpio_set_value(SHOOTER_CT_GPIO_USB_ID, 1);
		printk(KERN_INFO "%s %d output high\n",  __func__, SHOOTER_CT_GPIO_USB_ID);
	} else {
...
static void shooter_ct_usb_dpdn_switch(int path)
{
	switch (path) {
	case PATH_USB:
	case PATH_MHL:
	{
		...
		gpio_set_value(SHOOTER_CT_GPIO_MHL_USB_SWITCH, (mhl ^ !polarity) ? 1 : 0);
		break;
	}
	}
...
static struct cable_detect_platform_data cable_detect_pdata = {
	...
	.usb_id_pin_gpio = SHOOTER_CT_GPIO_USB_ID,
	.usb_dpdn_switch = shooter_ct_usb_dpdn_switch,
	.mhl_reset_gpio = SHOOTER_CT_GPIO_MHL_RESET,
	.mpp_data = {
		.usbid_mpp	=  PM8058_MPP_PM_TO_SYS(XOADC_MPP_4),
		.usbid_amux	= PM_MPP_AIN_AMUX_CH5,
	},
	.config_usb_id_gpios = config_shooter_ct_usb_id_gpios,
#ifdef CONFIG_FB_MSM_HDMI_MHL
...
static uint32_t mhl_gpio_table[] = {
	GPIO_CFG(SHOOTER_CT_GPIO_MHL_RESET, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_GPIO_MHL_INT, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};
...
static T_MHL_PLATFORM_DATA mhl_sii9234_device_data = {
	.gpio_intr = SHOOTER_CT_GPIO_MHL_INT,
	.gpio_reset = SHOOTER_CT_GPIO_MHL_RESET,
	.ci2ca = 0,
	#ifdef CONFIG_FB_MSM_HDMI_MHL
	.mhl_usb_switch		= shooter_ct_usb_dpdn_switch,
	.mhl_1v2_power = mhl_sii9234_1v2_power,
	#endif
...
{
	{
		...
		.irq = MSM_GPIO_TO_INT(SHOOTER_CT_GPIO_MHL_INT)
	},
};
#endif
#endif
...
static struct platform_device *shooter_ct_devices[] __initdata = {
	&ram_console_device,
	&msm_device_smd,
...
static void __init shooter_ct_reserve(void)
{
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
		...
		{
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_SDC3_DET),
			{
		...
		{ /* Audio Microphone Selector */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_MIC_SEL),    /* 26 */
			{
		...
		{ /* Audio Receiver Amplifier */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_HANDSET_ENO),	/* 17 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* Audio Speaker Amplifier */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_SPK_ENO),	/* 18 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* Timpani Reset */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_QTR_RESET),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_PLS_INT),
			{
				.direction		= PM_GPIO_DIR_IN,
		...
		{ /* Green LED */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_GREEN_LED),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* AMBER */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AMBER_LED),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* TORCH_SET1 for Flashlight */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_TORCH_SET1),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* TORCH_SET2 for Flashlight */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_TORCH_SET2),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* PMIC ID interrupt */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_REMO_PRES),
			{
				.direction	= PM_GPIO_DIR_IN,
				.pull		= PM_GPIO_PULL_UP_1P5,
				.vin_sel	= PM8058_GPIO_VIN_L5,
		...
		{
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_AUD_REMO_EN),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* 3D CLK */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_3DCLK),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* 3DLCM_PD */
			PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_3DLCM_PD),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
...
static uint32_t msm_spi_gpio[] = {
	GPIO_CFG(SHOOTER_CT_SPI_DO,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SPI_DI,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SPI_CS,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_CT_SPI_CLK, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static struct tpa2051d3_platform_data tpa2051d3_pdata = {
	.gpio_tpa2051_spk_en = SHOOTER_CT_AUD_HANDSET_ENO,
...
void __init shooter_ct_audio_init(void);
...
static struct isl29028_platform_data isl29028_pdata = {
	.intr = PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_PLS_INT),
...
static struct i2c_board_info i2c_isl29028_devices[] = {
	{
		...
		.irq = PM8058_GPIO_IRQ(PM8058_IRQ_BASE, SHOOTER_CT_PLS_INT),
	},
};
...
static struct i2c_board_info __initdata mpu3050_GSBI10_boardinfo[] = {
	{
		...
		.irq = MSM_GPIO_TO_INT(SHOOTER_CT_GYRO_INT),
...
#ifdef CONFIG_SERIAL_MSM_HS
	msm_uart_dm1_pdata.rx_wakeup_irq = gpio_to_irq(SHOOTER_CT_GPIO_BT_HOST_WAKE);
...
static void __init shooter_ct_map_io(void)
{
...
static unsigned int msm8x60_sdcc_slot_status(struct device *dev)
{
	...
	status = gpio_request(PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_SDC3_DET)
				, "SD_HW_Detect");
	if (status) {
		pr_err("%s:Failed to request GPIO %d\n", __func__,
				PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_SDC3_DET));
		...
		if (!status)
			status = !(gpio_get_value_cansleep(
				PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_SDC3_DET)));
		gpio_free(PM8058_GPIO_PM_TO_SYS(SHOOTER_CT_SDC3_DET));
	}
...
#ifdef CONFIG_MMC_MSM_SDC1_SUPPORT
static unsigned int shooter_ct_emmcslot_type = MMC_TYPE_MMC;
...
#endif
	.slot_type	= &shooter_ct_emmcslot_type,
	.msmsdcc_fmin	= 400000,
...
#ifdef CONFIG_MMC_MSM_SDC3_SUPPORT
static unsigned int shooter_ct_sdslot_type = MMC_TYPE_SD;
...
#endif
	.slot_type	= &shooter_ct_sdslot_type,
	.msmsdcc_fmin	= 400000,
	.msmsdcc_fmid	= 24000000,
	.msmsdcc_fmax	= 48000000,
	.nonremovable	= 0,
...
static struct msm_board_data shooter_ct_board_data __initdata = {
	.gpiomux_cfgs = msm8x60_shooter_ct_gpiomux_cfgs,
};

void shooter_ct_add_usb_devices(void)
{
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
	...
	*/
...
#ifdef CONFIG_PERFLOCK
	perflock_init(&shooter_ct_perflock_data);
#endif
	...
	platform_add_devices(shooter_ct_devices,
			     ARRAY_SIZE(shooter_ct_devices));

	/* usb driver won't be loaded in MFG 58 station */
	if (board_mfg_mode() != 6)
		shooter_ct_add_usb_devices();
	...
	shooter_ct_init_panel(msm_fb_resources, ARRAY_SIZE(msm_fb_resources));
	...
	if (properties_kobj)
		ret = sysfs_create_group(properties_kobj,
				&shooter_ct_properties_attr_group);

	shooter_ct_init_keypad();
	shooter_ct_wifi_init();
...
static void __init shooter_ct_init(void)
{
	msm8x60_init(&shooter_ct_board_data);
	printk(KERN_INFO "%s revision=%d engineerid=%d\n", __func__, system_rev, engineerid);
}

static void __init shooter_ct_charm_init_early(void)
{
	msm8x60_allocate_memory_regions();
}

static void __init shooter_ct_fixup(struct machine_desc *desc, struct tag *tags,
...
MACHINE_START(SHOOTER_CT, "shooter_ct")
	.fixup = shooter_ct_fixup,
	.map_io = shooter_ct_map_io,
	.reserve = shooter_ct_reserve,
	.init_irq = msm8x60_init_irq,
	.init_machine = shooter_ct_init,
	.timer = &msm_timer,
	.init_early = shooter_ct_charm_init_early,
MACHINE_END
